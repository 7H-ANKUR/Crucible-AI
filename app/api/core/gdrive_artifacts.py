"""app/api/core/gdrive_artifacts.py — Google Drive artifact registry and downloader.
...
logger = logging.getLogger("crucible.gdrive")
...
# Default Google Drive folder URL and ID containing Crucible AI model artifacts
