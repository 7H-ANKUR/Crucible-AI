...
---------------------------------
Uses SIH26009_DATA datasets to verify CrucibleOrchestrator
...
"""
import sys
sys.path.insert(0, r"c:\Users\HP\Desktop\Crucible\Crucible_Foundation_v0_1")

import pandas as pd
import tempfile
from pathlib import Path

from core.platform.orchestrator import CrucibleOrchestrator

DATA_ROOT = Path(r"c:\Users\HP\Desktop\Crucible\Crucible_Foundation_v0_1\source_friend_v1\SIH26009_DATA\ml_ready")
...
def run_smoke(path: Path, target=None, task_type=None, label=""):
    ...
    with tempfile.TemporaryDirectory() as td:
        orch = CrucibleOrchestrator(checkpoint_root=td+"/c", artifact_root=td+"/a")
