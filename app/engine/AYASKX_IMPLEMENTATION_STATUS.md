# Crucible AI implementation status

Audit date: 2026-09-08

## Current architecture

Crucible AI is a Python research-platform foundation with a React/Vite operations UI.
...
- `core.platform.CrucibleOrchestrator` is the intended end-to-end coordinator:
...
- the older `core.pipeline_legacy.CruciblePipeline` and `core.checkpoints` package.
...
- `CRUCIBLE_CORS_ORIGINS` defaults to `*` while credentialed CORS is enabled. This
