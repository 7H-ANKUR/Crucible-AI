...
------------------------------
Crucible AI Core Platform Orchestrator.

Phases B + C: PIPELINE UNIFICATION + EXECUTION ENGINE

This module provides the single coherent entry point for the Crucible AI
...
class OrchestratorResult:
    """
    Immutable top-level result returned by CrucibleOrchestrator.run().
    """
...
class CrucibleOrchestrator:
    ...
    Connects the existing Crucible AI modules into one coherent pipeline.
    ...
    def __init__(
        self,
        checkpoint_root: str | Path = ".crucible_checkpoints",
        artifact_root: str | Path = ".crucible_artifacts",
    ...
    def run(
        ...
        *,
        ...
        """
        Execute the full Crucible AI intelligent ML pipeline.
