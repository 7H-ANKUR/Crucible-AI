"""apps/api/core/security.py — JWT auth + demo bootstrap (no hardcoded passwords).
...
logger = logging.getLogger("minex.security")
...
def _get_clerk_jwks() -> dict:
    ...
    try:
        req = urllib.request.Request(url, headers={"User-Agent": "MINEx-FastAPI-JWKS"})
