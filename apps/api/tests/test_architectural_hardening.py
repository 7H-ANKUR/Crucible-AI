"""apps/api/tests/test_architectural_hardening.py — Tests for the 6 architectural hardening pillars."""
import pytest
from fastapi.testclient import TestClient

from apps.api.core.ml_loader import MODELS, smoke_test_model
from apps.api.core.storage import StorageService
