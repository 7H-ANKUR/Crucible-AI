"""apps/api/tests/test_storage.py — Unit tests for StorageService and artifact caching."""
from apps.api.core.storage import StorageService, compute_sha256


def test_compute_sha256():
    """Verify SHA-256 computation matches standard library hashlib."""
    import hashlib
    data = b"MINEx enterprise storage test content"
