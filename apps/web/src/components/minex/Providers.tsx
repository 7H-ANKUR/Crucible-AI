...
/**
 * Providers — Clerk auth wired into the MINEx role model.
 * - ClerkThemed: ClerkProvider with theme-reactive appearance.
 * - RoleBridge: exposes publicMetadata.role through MinexAuthProvider.
 */
import React from 'react';
import { ClerkProvider, useUser } from '@clerk/nextjs';
import { MinexAuthProvider, type Role } from '@/lib/roles';
...
import { SmoothScroll } from '@/components/minex/SmoothScroll';

export function MinexProviders({ children }: { children: React.ReactNode }) {
  return (
    <ClerkThemed>
